...
╚═╝░░╚═╝╚═╝░░╚═╝╚══════╝╚═╝░░╚══╝╚═╝░░╚═╝░░░╚═╝░░░╚═════╝░  ╚═════╝░░╚════╝░░░░╚═╝░░░
    ...
    print_border("ARENAVS BOT", Fore.GREEN)
...
async def run_arenavs(language: str):
    from scripts.arenavs import run_arenavs as arenavs_run
    await arenavs_run(language)
...
def get_available_scripts(language):
    scripts = {
        'vi': [
            {"name": "1. Hoàn thành tự động nhiệm vụ GPT360 x ArenaVS │ ArenaVS Bot", "value": "arenavs"},

            {"name": "2. Thoát", "value": "exit"},
        ],
        'en': [
            {"name": "1. Auto task GPT360 x ArenaVS │ ArenaVS Bot", "value": "arenavs"},
